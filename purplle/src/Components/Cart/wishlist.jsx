...
import {
  ...
  GET_CARD_DATA,
} from "../../Redux/CartRedux/cart_action";
...
function Wishlist() {
  ...
  const { Cart_Items, loading, auth } = useSelector(
        ...
        <div>
          {data.CardItem.length === 0 ? (
            <div>
              ...
              <img src="https://fatafatsewa.com/website/images/emptycart.png" alt="" />
              <h1>Add in your Wishlist</h1>

              </Text>
              <Button p="5px" mb="15px" backgroundColor="purple.100" >
